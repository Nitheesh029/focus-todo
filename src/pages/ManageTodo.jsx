...
const ManageTodo = () => {
  ...
  return (
    <div className="mt-10 w-[80%] md:max-w-7xl mx-auto p-6">
      ...
      <div className="flex w-full flex-col md:flex-row mx-auto text-center mt-10">
        <div className="flex flex-col w-full md:w-[20%] gap-5 items-center border-2 border-gray-200 py-5 rounded-md">
          <StatsCard
            title={"Total Task"}
            icon={<ClipboardCheck />}
            value={totalTasks}
        ...
        <div className="flex flex-col flex-1 w-full md:w-[70%] mt-8 md:mt-0 md:ml-8">
